package ru.bmstu.cp.rsoi.analyzer.web.handler;
...
import ru.bmstu.cp.rsoi.analyzer.model.GenericResponse;
...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    // 500
    @ExceptionHandler({ FailureWhenSearchException.class })
    public ResponseEntity<Object> handleFailureWhenSearch(final FailureWhenSearchException ex, final WebRequest request) {
        ex.printStackTrace();
